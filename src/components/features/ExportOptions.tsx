...
import { uploadContractPdf, saveContractToSheet, ExtraSheet, uploadContractPdfToDrive, buildContractFileName } from '@/lib/sheetsApi';
...
interface ExportOptionsProps {
  ...
  /** Manager's Google Drive folder ID for automatic PDF backup */
  managerDriveFolderId?: string;
}
