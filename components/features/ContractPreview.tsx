...
import { getForwarder, Forwarder } from '@/lib/forwardersApi';
    ...
    return (
      <div style={{ marginTop: '16px' }}>
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: '16px', flexWrap: 'wrap' }}>
          <div style={{ position: 'relative' }}>
            ...
            {data.includeSignature && signatureUrl && (
              <img src={signatureUrl} alt="signature"
                style={{ position: 'absolute', bottom: '-4px', left: '70px', height: `${sigH}px`, width: 'auto', objectFit: 'contain' }} />
            )}
            {data.includeSignature && !signatureUrl && (
          ...
          {data.includeStamp && (
            stampUrl
              ? <img src={stampUrl} alt="stamp" style={{ height: `${stmpH}px`, width: `${stmpW}px`, objectFit: 'contain', opacity: 0.85 }} />
              : (
                <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', border: '3px solid #1a3a6b', borderRadius: '50%', width: `${stmpW}px`, height: `${stmpH}px`, fontSize: '6pt', fontWeight: 'bold', color: '#1a3a6b', textAlign: 'center', lineHeight: '1.3', padding: '8px', flexShrink: 0 }}>
